...
class FlashHelper {
  ...
  Future<T> snackBar<T>(
    ...
    HorizontalDismissDirection horizontalDismissDirection = HorizontalDismissDirection.horizontal,
    ...
    final _borderRadius = borderRadius ?? const BorderRadius.all(Radius.circular(0));
        ...
        return Flash(
          ...
          child: FlashBar(
            ...
            primaryAction: onPrimaryActionTap == null
                ? FlatButton(
                    onPressed: onPrimaryActionTap == null ? null : () => onPrimaryActionTap(controller),
          ...
          child: FlashBar(
            ...
            actions: <Widget>[
              if (negativeAction != null)
                FlatButton(
                  onPressed: negativeActionTap == null ? null : () => negativeActionTap(controller),
                  child: negativeAction,
                ),
              if (positiveAction != null)
                FlatButton(
                  onPressed: positiveActionTap == null ? null : () => positiveActionTap(controller),

...
import 'package:formletics/common/themes/dark_theme.dart';
import 'package:formletics/common/themes/light_theme.dart';
...
ThemeModel getDefaultAppTheme() {
  return const ThemeModel(mode: ThemeMode.dark);
}

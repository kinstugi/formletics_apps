...
TrainerPanelServiceResponseModel _$TrainerPanelServiceResponseModelFromJson(
    Map<String, dynamic> json) {
  return TrainerPanelServiceResponseModel(
    id: json['id'] as int,
...
Map<String, dynamic> _$TrainerPanelServiceResponseModelToJson(
        TrainerPanelServiceResponseModel instance) =>
    <String, dynamic>{
      'id': instance.id,

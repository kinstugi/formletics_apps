...
TrainerPanelSportsmanNestedNo _$TrainerPanelSportsmanNestedNoFromJson(
    Map<String, dynamic> json) {
  return TrainerPanelSportsmanNestedNo(
    id: json['id'] as int,
...
Map<String, dynamic> _$TrainerPanelSportsmanNestedNoToJson(
        TrainerPanelSportsmanNestedNo instance) =>
    <String, dynamic>{
      'id': instance.id,
